...
function resetGame(){
	var answer = confirm("Are you sure you want to completely restart?")
	if(answer)
...
function loadMaze() {
	...
	$('#totalDiv').css('width', (mazeSizeX*60));
	$('#gameDiv').css('width', (mazeSizeX*60));
	$('#gameDiv').css('height', (mazeSizeY*60));
